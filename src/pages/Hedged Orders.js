...
export default function HedgedOrders() {
                        ...
                        return Object.keys(state.Cycles[symbol]).map((magic, id) => {
                          ...
                          return (
                            <>
                              {Render && <>
                                <TableRow>
                                  <TableCell style={{ paddingBottom: 10, paddingTop: 10 }} colSpan={20}>
                                ...
                                <TableRow hover key={id}  >
                                  ...
                                  <TableCell align="left">
                                    <Button onClick={() => CloseCycle(magic)} variant="contained" color="error">  Close </Button>
                                  </TableCell>
                                  <TableCell align='left'>
